...
<div id="page-wrapper">
        <div class="container-fluid text-white" style="background-color: #0D0730">
            <!-- Page Heading -->
           <h3><i class="fa fa-user-circle-o"></i> <b>Slider Details</b></h3>
  ...
  <table id="example" class="table table-striped table-bordered mt-3 text-white" style="width:100%;" cellpadding="0" cellspacing="0">
      ...
      <tbody>
        ...
        <a href="slider_delete.php?id=<?php echo $data['id'];?>" name="delete" class="btn btn-sm rounded bg-danger text-white edit_delete_style" onclick="return confirm('Are you sure to Delete this slider image?');"><i class="fa fa-trash"></i></a>
        </span>
      </td>
        <?php 
