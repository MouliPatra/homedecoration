...
$product_id=$_GET['id'];
$product_data=getsingleProductDetails($product_id);
?>
...
<div class="form-outline mb-4 w-50 mx-auto">
	...
	<input type="text" name="product_title" id="product_title" class="form-control" placeholder="enter product title" required="required" value="<?php echo $product_data['p_name']; ?>">
</div>
<div class="form-outline mb-4 w-50 mx-auto">
   <label class="form-label">Product description</label>

	<input type="text" name="product_des" id="product_des" class="form-control" placeholder="enter product description" required="required" value="<?php echo $product_data['p_description']; ?>">
</div>
<div class="form-outline mb-4 w-50 mx-auto">
...
<div class="form-outline mb-4 w-50 mx-auto">
	...
	<input type="text" name="Actual_price" id="Actual_price" class="form-control" onkeyup="discount_value();" value="<?php echo $product_data['actual_price']; ?>">
</div>
<div class="form-outline mb-4 w-50 mx-auto">
	<label class="form-label">Discount(%)</label>
	<input type="text" name="discount" id="discount" class="form-control" onkeyup="discount_value();" value="<?php echo $product_data['discount']; ?>">
</div>


<div class="form-outline mb-4 w-50 mx-auto">
	<label class="form-label">Discount Price</label>
	<input type="text" name="discount_price" id="discount_price" class="form-control" value="<?php echo $product_data['discount_price']; ?>">
</div>
<div class="form-outline mb-4 w-50 mx-auto">
...
<!-- <div class="form-outline mb-4 w-50 mx-auto">
	...
	<div class="form-outline mb-4 w-50 mx-auto">
	<input type="submit" name="submit" class="btn btn-info" value="Update Products" onclick="return check();">
</div>
	</form>
</div>
</div>
